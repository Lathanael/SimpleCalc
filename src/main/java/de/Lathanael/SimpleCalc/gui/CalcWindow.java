...
public class CalcWindow extends GenericPopup {
	...
	public CalcWindow (SpoutPlayer player, SimpleCalc plugin) {
		...
		close.setHeight(10).setWidth(10).setX(edges.getRight()-7).setY(edges.getTop()-5);
		...
		hide.setHeight(10).setWidth(10).setX(edges.getRight()-19).setY(edges.getTop()-5);
	...
	public void onClick(Button button) {
		...
		if (button.equals(scViewOn))
			...
			expression.setText(expression.getText() + "SQRT(");
			expression.setDirty(true);
		}
	}
}
